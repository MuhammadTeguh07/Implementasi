      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">         
              <form class="form-horizontal form-label-left" methode="POST" action="/customer/insert2">
                {{ csrf_field() }}
...
<script>
    jQuery('select[name="provinsi"]').on('change',function(){
      ...
      {
        jQuery.ajax({
          url : '/customer/create2/getKota/' +provinsiID,
          type : "GET",
          dataType : "json",
...
<script>
    jQuery('select[name="kota"]').on('change',function(){
      ...
      {
        jQuery.ajax({
          url : '/customer/create2/getKecamatan/' +kotaID,
          type : "GET",
          dataType : "json",
          success:function(data)
          {
...
<script>
    jQuery('select[name="kecamatan"]').on('change',function(){
      ...
      {
        jQuery.ajax({
          url : '/customer/create2/getKelurahan/' +kecamatanID,
          type : "GET",
          dataType : "json",
          success:function(data)
          {
