            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section active">
                ...
                <ul class="nav side-menu" style="">
                  ...
                  <li><a><i class="fa fa-map-marker"></i>Score Board<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="block;">
                      <li><a href="/scoreboard-controller">Kontrol</a></li>
                      <li><a href="/scoreboard">Papan Skor</a></li>
                    </ul>
                  </li>
